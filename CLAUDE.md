...
Deployed to production at stelld.ca. MVP features complete, bilingual (EN/FR) complete, Stripe payments complete (subscriptions + Connect + form payment collection), banner uploads complete, custom slugs complete.
